...
<!-- 						<view class="row">
						...
						<view class="copyright">
							声明：本图片来用户投稿，非商业使用，用于免费学习交流，如侵犯了您的权益，您可以拷贝壁纸ID举报至平台，邮箱2162627569@qq.com，管理将删除侵权壁纸，维护您的权益。
						</view>
		...
		<uni-popup ref="scorepopup" :is-mask-click="false">
			...
			<view class="footer">
				<button @click="submitscore" type="default" 
				size="mini" plain :disabled="!userScore || isScore">确认评分</button>
			</view>
			</view>
		</uni-popup>
